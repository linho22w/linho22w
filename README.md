...
<p align="center">
  ...
  <a href="mailto:paulinhoamorim7@hotmail.com">
...
**"Contextual Generative Models for Time Series using High-Performance Computing"**
*(original title: "Modelos Generativos Contextuais para Séries Temporais com Recurso a Computação de Alto Desempenho")*

Researching and developing generative models for time series data, with the training/inference pipeline designed to take advantage of high-performance computing resources.
